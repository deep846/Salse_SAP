					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Salse Order Purchase",
									"targetURL": "#salseorder-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"salseorder-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=salseorder",
									"url": sap.ui.require.toUrl("salseorder")
								}
							}
						}
					}
